...
class ClothingWebsiteFolio extends React.Component {
  state = {
  ...
  render() {
    ...
    return (
      <AboutMeWrapper>
        <Layout theme="white" openContactPopup={()=> window.open("https://www.linkedin.com/in/ryan-long-6a8aaa19a/", "_blank")}>
          <AboveFold>
...
export default ClothingWebsiteFolio;
